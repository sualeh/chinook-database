...
[Reference the jar file in your Maven or Gradle project](https://search.maven.org/artifact/us.fatehi/chinook-database/2.1.3/jar), and load the SQL scripts as resources in your program.
