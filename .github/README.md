...
Download the jar can be [downloaded from The Central Repository][download], and unzip them using a standard unzip program. The scripts will be in a directory called `chinook_database`.
